...
The MVC architecture was used heavily in this project.
...
// 4 \\ - REQUIREMENTS
Aside from standard PC low-level requirements, the Boost library is necessary for the serialization.
Please refer to your proper VS/OS version.
